        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Putri Amaliah</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url();?>index.php/crud/add_rute" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputRute_From">Rute From</label>
                  <input type="text" class="form-control" name="rute_from" id="exampleInputRute_From" placeholder="Enter Rute" value="<?php echo $rute_from?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputRute_To">Rute To</label>
                  <input type="text" class="form-control"  name="rute_to" id="exampleInputRute_To" placeholder="Enter Rute" value="<?php echo $rute_to?>">
                </div>
                <div class="form-group">
